...
//toString() - devolve um número com uma string
...
console.log(number.toExponential()); // 1.2345e+2
console.log(number.toExponential(1)); // 1.2e+2

//toLocaleString() - devolva uma string com uma representação do número sensível ao idioma
